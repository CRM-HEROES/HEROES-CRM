...
class ProjectNewMessagesStat implements StatInterface
{
    ...
    public function key()
    {
        return "prospect.message.new" . ($this->thread ? ".thread." . $this->thread->id : "") . ($this->country ? ".country." . $this->country : "");
    }
    ...
    public function value($date, $userId = null)
    {
        return DB::table('messages')
            ...
            ->whereBetween('messages.created_at', [$date . ' 00:00:00', $date . ' 23:59:59'])
