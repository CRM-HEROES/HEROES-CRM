...
class ProjectNewSmsStat implements StatInterface
{
    ...
    public function key()
    {
        return "prospect.sms.new" . ($this->source ? ".source." . $this->source : "") . ($this->country ? ".country." . $this->country : "");
    }
    ...
    public function value($date, $userId = null)
    {
        return DB::table('sms')
            ...
            ->whereBetween('sms.created_at', [$date . ' 00:00:00', $date . ' 23:59:59'])
