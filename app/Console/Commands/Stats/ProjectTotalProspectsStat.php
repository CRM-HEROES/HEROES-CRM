...
class ProjectTotalProspectsStat implements StatInterface
{
    ...
    public function key()
    {
        return "prospect.total" . ($this->country ? ".country." . $this->country : "");
    }
    ...
    public function value($date, $userId = null)
    {
        return DB::table('prospects')
            ...
            ->where('prospects.created_at', '<=', $date . ' 23:59:59')
