...
class ProjectNewInteractionsDurationsStat implements StatInterface
{
    ...
    public function key()
    {
        return "prospect.interaction.duration.new" . ($this->source ? ".source." . $this->source : "") . ($this->country ? ".country." . $this->country : "");
    }
    ...
    public function value($date, $userId = null)
    {
        return DB::table('interactions')
            ...
            ->whereBetween('interactions.started_at', [$date . ' 00:00:00', $date . ' 23:59:59'])
