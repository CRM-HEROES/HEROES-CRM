...
class ProjectNewOrdersValuesStat implements StatInterface
{
    ...
    public function key()
    {
        return "prospect.order.value.new" . ($this->status ? ".status." . $this->status->id : "") . ($this->country ? ".country." . $this->country : "");
    }
