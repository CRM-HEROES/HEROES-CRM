...
class ProjectNewEventsStat implements StatInterface
{
    ...
    public function key()
    {
        return "prospect.event.new" . ($this->calendar ? ".calendar." . $this->calendar->id : "") . ($this->country ? ".country." . $this->country : "");
    }
    ...
    public function value($date, $userId = null)
    {
        return DB::table('events')
            ...
            ->whereBetween('events.started_at', [$date . ' 00:00:00', $date . ' 23:59:59'])
