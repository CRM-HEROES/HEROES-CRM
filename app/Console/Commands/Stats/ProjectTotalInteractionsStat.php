...
class ProjectTotalInteractionsStat implements StatInterface
{
    ...
    public function key()
    {
        return "prospect.interaction.total" . ($this->source ? ".source." . $this->source : "") . ($this->country ? ".country." . $this->country : "");
    }
