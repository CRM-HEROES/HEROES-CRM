...
class ProjectTotalOrdersValuesStat implements StatInterface
{
    ...
    public function key()
    {
        return "prospect.order.value.total" . ($this->status ? ".status." . $this->status->id : "") . ($this->country ? ".country." . $this->country : "");
    }
