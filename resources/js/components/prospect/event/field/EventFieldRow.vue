<template>
    <item class="hc-event-field-row">
        <icon class="fa fa-info" />
        <div class="hc-event-field-name" v-text="field.name"></div>
        <div class="hc-item-main-content hc-event-field-input">
            <input
                v-if="field.type == 'tel'"
                type="tel"
                v-model.lazy="value"
...
.hc-event-field-input {
    height: 100%;
}

.hc-event-field-input > input,
.hc-event-field-input > textarea {
    width: 100%;
    height: 100%;
    padding: 0 15px;
}
