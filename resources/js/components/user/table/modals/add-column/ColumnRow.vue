...
export default {
    ...
    methods: {
        ...
        async removeColumn() {
            // Get user users table settings
            let newSettings = this.projectUserSettingsUsersTable.map((column) =>
    ...
    computed: {
        ...
        existingColumn() {
            return this.projectUserSettingsUsersTable.find(
                (c) => c.key == this.column.columnId
            );
        },

        existing() {
            return this.projectUserSettingsUsersTableHas(this.column.columnId);
        },
    },
};
</script>
