<template>
    <a class="hc-user-file hc-flex-column" :href="file.url">
        ...
        <div class="hc-user-file-size" v-text="size"></div>
...
.hc-user-file-thumbnail-content {
    text-align: center;
    width: 100%;
    padding-top: 80%;
}

.hc-user-file-thumbnail-content > img {
    bottom: 0;
    height: auto;
    left: 0;
    margin: auto;
...
.hc-user-file:hover .hc-user-file-remove {
    opacity: 1;
    transform: scale(1);
}
