<template>
    <field-template type="html" :content="'{order.' + field.slug + '}'">
        <item class="hc-document-order-default-field">
            <icon class="fa fa-shopping-cart" icon-size="11" :size="30" />
...
<style>
.hc-document-order-default-field .hc-item-main-content {
    font-size: 11px;
}
</style>
