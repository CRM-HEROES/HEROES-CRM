<template>
    <campaign-template :field="field">
        <item class="hc-campaign-rule-user-row">
            <icon class="fa fa-user" icon-size="11" :size="30" />
...
<style>
.hc-campaign-rule-user-row .hc-item-main-content {
    font-size: 11px;
}
</style>
...
export default {
    ...
    data() {
        return {
            field: {
                action: "prospect-detach-user",
                name: "Detacher de l'utilisateur " + this.user.name,
                category: "action",
                value: {
                    user: this.user.id,
                },
